  ...
  useEffect(() => {
    ...
    const initMap = () => {
      const map = new window.google.maps.Map(document.getElementById("map"), {
        center: { lat: 26.7637, lng: 83.3732 }, // Coordinates of NIELIT Gorakhpur
        zoom: 15,
      });

      // Add Marker for NIELIT Gorakhpur
      new window.google.maps.Marker({
        position: { lat: 26.7637, lng: 83.3732 },
        map,
        title: "NIELIT Gorakhpur",
      });
    };
  ...
  return (
    <div>
      ...
      <div className="text-[28px] bg-gray-600">
        <h1 className="ml-45 p-2 text-gray-100 cursor-pointer hover:text-gray-200 font-semibold transition-all">
          Contact Us
        </h1>
      </div>
      <div className="bg-gray-100 p-8">
        <div className="max-w-6xl mx-auto bg-white p-6 shadow-lg rounded-lg">
          ...
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Faculty Contacts</h3>
